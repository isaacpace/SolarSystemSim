...
class Planet:
    def __init__(self, name, posx, posy, vx, vy, radius, fact, image_path = None):
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        with open('planets.yml', 'r') as f:
            ...
            for planet in data:
                self.planets.append(Planet(planet['name'], planet['aphelion'], 0, 0, planet['initial_speed'], planet['radius'], planet['fact'], planet['image']))
